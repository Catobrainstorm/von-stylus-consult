...
const team = [
  ...
  { n:"04", name:"John Vaughan", role:"Cloud Security & Tech Advisor", bio:"Senior IAM Security Engineer at Scopely with 6+ years across Azure, AWS, and GCP. Identity architect based in Portugal.", expertise:["Cloud Security","Identity Architecture","Zero-Trust"], color:"#9B94F0", photo:"/images/john_vaughan.jpeg" },
