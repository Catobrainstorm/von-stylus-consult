...
// ✅ UPDATED: Professional Black personnel and category-specific imagery
const work = [
  { 
  ...
  { 
    ...
    img:"https://images.pexels.com/photos/7841856/pexels-photo-7841856.jpeg?auto=compress&cs=tinysrgb&w=800" 
  },
  { 
    ...
    img:"https://images.pexels.com/photos/3184328/pexels-photo-3184328.jpeg?auto=compress&cs=tinysrgb&w=800" 
  },
  { 
...
export default function Clients() {
  ...
  return (
    <section id="clients" style={{ background:"#09071a" }}>
      ...
      <div className="max-w" style={{ margin: "0 auto", padding:"clamp(5rem,10vw,8rem) clamp(1.25rem,5vw,4rem)" }}>
        <div data-reveal style={{ display:"flex", flexWrap:"wrap", alignItems:"flex-end", justifyContent:"space-between", gap:"1.5rem", marginBottom:"clamp(3rem,6vw,5rem)" }}>
          <div>
            ...
            <h2 style={{ fontFamily:"'Young Serif', serif", fontWeight:400, fontSize:"clamp(2rem,5vw,4.5rem)", color:"#fff", lineHeight:1.05 }}>
          ...
          {work.map((w, i) => (
            ...
            >
              ...
              <div style={{ position:"relative", zIndex:2, height:"100%", display:"flex", flexDirection:"column", justifyContent:"flex-end", padding:"2rem" }}>
                ...
                <h3 style={{ fontFamily:"'Young Serif', serif", fontWeight:400, color:"#fff", fontSize:"1.4rem", marginBottom:"0.6rem" }}>{w.title}</h3>
      ...
      <div style={{ background:"#f8f6ff", padding:"clamp(5rem,10vw,8rem) 0" }}>
        <div className="max-w" style={{ margin: "0 auto", padding:"0 clamp(1.25rem,5vw,4rem) 4rem" }}>
          ...
          <h2 data-reveal style={{ fontFamily:"'Young Serif', serif", fontWeight:400, fontSize:"clamp(2rem,4.5vw,4rem)", color:"#09071a", lineHeight:1.1 }}>
            ...
            <div className="marquee-content">
              {[...clients,...clients,...clients].map((c,i)=>(
                <div key={i} className="client-card">
                  <span style={{ fontFamily:"'Young Serif', serif", fontWeight:400, fontSize:"0.9rem", color:"#4B44A8", whiteSpace:"nowrap" }}>{c}</span>
                </div>
              ))}
            </div>
          </div>
